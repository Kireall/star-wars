    ...
    return (
        <List
            ...
            renderItem={(item) => {
                 ...
                 * Но она не работает (хехе=))
                 * Тут надо обдумывать, как делать - прятать под спойлер и при открытии отправлять запрос и отображать инфу,
                 * либо как-то по-другому. Но сразу дергать все урлы из данных - не оч хорошая идея.
                 */
